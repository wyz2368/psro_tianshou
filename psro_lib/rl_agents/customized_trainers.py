"""
Since Tianshou on PYPI is still developing, this file creates customized OnPolicyTrainer
and OffPolicyTrainer classes.
The main change is to assign default values for argument.
This file can be depreciated in this future.
"""
...
class OffpolicyTrainer_customized(BaseTrainer):
...
def offpolicy_trainer(*args, **kwargs) -> Dict[str, Union[float, str]]:  # type: ignore
    ...
    """
    return OffpolicyTrainer_customized(*args, **kwargs).run()


offpolicy_trainer_iter = OffpolicyTrainer_customized



class OnpolicyTrainer_customized(BaseTrainer):
...
def onpolicy_trainer(*args, **kwargs) -> Dict[str, Union[float, str]]:  # type: ignore
    ...
    :return: See :func:`~tianshou.trainer.gather_info`.
    """
    return OnpolicyTrainer_customized(*args, **kwargs).run()


onpolicy_trainer_iter = OnpolicyTrainer_customized
