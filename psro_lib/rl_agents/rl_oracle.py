...
class RLOracle:
    ...
    def __init__(self,
                 env,
                 trainer, # An MApolicyTrainer object in mapolicy_trainer.py
        ...
        for player in range(len(self.env.agents)):
            if not copy_from_prev:
                ...
                net = Net(state_shape=self._best_response_kwargs["state_size"],
                          ...
                          hidden_sizes=self._best_response_kwargs["hidden_layers_sizes"],
                ...
                policy = self._best_response_class(model=net,
                                                   optim=optim,
                                                   discount_factor=1.0,
                                                   estimation_step=1, # The number of steps to look ahead.
    ...
    def train(self,
        ...
        for i in range(self._number_training_episodes):
            ...
            for learning_player in range(self.num_players):
                ...
                # if self.verbose:
                #     #TODO: logging training info.
                #     print("======== {} =========".format(i))
                #     print("loss:", losses)
                #     print("train_rew:", train_rew)
