...
def lp_solve(meta_games, checkpoint_dir=None):
    ...
    nash_prob_1, nash_prob_2, _, _ = (solve_zero_sum_matrix_game(pyspiel.create_matrix_game(*meta_games)))
    result = [
...
def is_dominated(action,
  ...
  payoffs = game_payoffs_array(game_or_payoffs)[player] if isinstance(
